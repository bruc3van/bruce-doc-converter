...
**DocuGenius Converter** 是一个 **Agent Skill**，为 **Claude Code / OpenClaw** 添加**双向文档转换**能力。安装后，AI 可以：
...
与官方 docx 等通用 skill 相比，DocuGenius Converter 预置了完整的转换脚本：
...
```
帮我安装这个 skill：https://github.com/brucevanfdm/docugenius-converter-skill
```
